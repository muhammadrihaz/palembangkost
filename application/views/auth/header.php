...
<body>
    <nav class="navbar navbar-expand-md navbar-dark bg-tomato">
        <a class="navbar-brand" href="">PalembangKost</a>
        ...
        <div class="collapse navbar-collapse" id="pkostnavbar">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="">Promosikan Kost</a></li>
                <li class="nav-item"><a class="nav-link" href=""><span class="lnr lnr-lock"></span> Login</a></li>
            </ul>
        </div>
    </nav> 